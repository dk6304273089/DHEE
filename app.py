...
try:
    ...
    input1=col1.number_input("Enter the value of aa_000",min_value=0,max_value=2746564)
    input2=col2.number_input("Enter the value of ag_002",min_value=0,max_value=10552856)
    col3,col4=st.columns(2)
    input3=col3.number_input("Enter the value of cs_004",min_value=0,max_value=74860628)
    input4=col4.number_input("Enter the value of ay_008",min_value=0,max_value=104566992)
    col5,col6=st.columns(2)
    input5=col5.number_input("Enter the value of dn_000",min_value=0,max_value=2924584)
    input6=col6.number_input("Enter the value of cj_000",min_value=0,max_value=60949671)
    ok = st.button("SUBMIT")
